...
//        appInfos.add(new appNetInfo(-1, parseProcNetRoute()));
    ...
    private boolean saveFile() {
        ...
        try {
            dir = new File(Environment.getExternalStorageDirectory(), "Blocker");
            if (!dir.exists()) {
                dir.mkdir();
            }
            SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
//            output.append();
            file = new File(Environment.getExternalStorageDirectory() +"/Blocker", "B-" +dateFormat.format(new Date()).toString() +".txt");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getListView().setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent i = new Intent(MainActivity.this, TurnDataOnOff.class);
                startActivity(i);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_refresh) {
            ...
            buildNetstat();
            adapter.notifyDataSetChanged();
            Toast.makeText(getApplicationContext(), "Blocker app refreshed", Toast.LENGTH_SHORT).show();
            return true;
