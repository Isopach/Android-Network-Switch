...
public class netInfoAdapter extends ArrayAdapter<appNetInfo> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView app_name = (TextView) rowView.findViewById(R.id.app_name);
        ...
        try {
            app_name.setText(context.getPackageManager().getApplicationLabel(context.getPackageManager().getApplicationInfo(appName, PackageManager.GET_META_DATA)));
